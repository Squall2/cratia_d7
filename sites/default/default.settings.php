...
if (class_exists('Memcache')) {
  $conf['memcache_storage_key_prefix'] = __DIR__;
...
if ($_SERVER["REMOTE_ADDR"] != '127.0.0.1') {
  $conf['preprocess_css'] = $conf['preprocess_js'] = 1;
}

$conf['file_public_path']    = conf_path() . '/files';
$conf['file_private_path']   = conf_path() . '/files/.ht.private';
$conf['file_temporary_path'] = conf_path() . '/files/.ht.tmp';
$conf['filecache_directory'] = __DIR__     . '/files/.ht.filecache';
